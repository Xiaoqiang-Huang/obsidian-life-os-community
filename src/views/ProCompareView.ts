...
const PLAN_CARDS = [
  ...
  },
  {
    ...
    points: ["短期 Pro 使用", "设备数最多 3 台", "支付宝订单自动激活", "授权码备份与恢复"],
    pro: true
  },
  {
    title: "买断 Pro",
    price: "49 元一次买断",
    icon: "sparkles",
    copy: "定位为长期 Pro 使用，适合长期用户的主力 Vault；价格 49 元一次买断，设备数最多 5 台。",
    points: ["长期 Pro 使用", "49 元一次买断", "设备数最多 5 台", "一次买断永久使用"],
    pro: true
  }
];
...
export class ProCompareView extends ItemView {
  ...
  async onOpen(): Promise<void> {
    ...
    createHeroHeader(main, {
      ...
      title: "按模块和能力看版本差异",
      description: "免费版免费使用，定位为基础手动使用，支持 1 台本地使用；30 天试用免费一次，定位为完整体验 Pro，功能与 Pro 一致，设备数最多 3 台，用于完整体验本地优先的核心工作流；月付 Pro 定位为短期 Pro 使用，价格 9.9 元 / 30 天，设备数最多 3 台，面向阶段性高频、一个月周期和临时多设备授权；买断 Pro 定位为长期 Pro 使用，价格 49 元一次买断，设备数最多 5 台，适合长期用户的主力 Vault。数据查看、导出和迁移入口不会被 Pro 锁死。",
      icon: "columns-3",
      actions: [
