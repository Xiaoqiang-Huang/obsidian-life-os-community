...
const MODULE_ROWS: ModuleCompareRow[] = [
  ...
  {
    module: "知识库",
    ability: "知识库工作台 / 新增资料 / 内容流",
    free: "支持。可查看 Raw 原始资料、Draft 草稿、正式知识和普通笔记，也能手动新增资料。",
    trial: "同 Pro 支持。知识库内容流和新增资料入口不因授权状态变化而锁死。",
    monthly: "支持。可结合 AI 写回、LLM Wiki 整理和内容流复用知识。",
    lifetime: "支持。长期保留知识库工作台、内容流、导出和迁移入口。"
  },
  {
    module: "知识库",
